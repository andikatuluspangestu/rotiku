                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-xl bg-danger">
                                        {{-- Shop Bag --}}
                                        <i class="fa-solid fa-shopping-bag text-light"></i>
                                    </div>
                                    <div class="ms-3">
                                        <h5 class="font-bold text-light">
                                            {{ $orders->count() }}
            ...
            <div class="col-12 col-lg-3">
                ...
                <div class="card bg-primary shadow-sm">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-xl bg-primary">
                                <i class="text-light fa-solid fa-wallet"></i>
                            </div>
                            <div class="ms-3">
                                <h5 class="font-bold text-light">Total Pembelian</h5>
                                <h6 class="text-light mb-0">
                ...
                <div class="card bg-success shadow-sm">
                    <div class="card-body text-light">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h5 class="font-bold text-light">Produk Favorit</h5>
                                <h6 class="text-light mb-0">
                                    @foreach ($products as $product)
